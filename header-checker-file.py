...
def main():
    parser = argparse.ArgumentParser(description='Check HTTP headers for domains listed in a file')
    parser.add_argument('-f', '--file', required=True, help='Input file containing domains (one per line)')
    parser.add_argument('-o', '--output', help='Output CSV file', 
                        default=f'header_analysis_{datetime.now().strftime("%Y%m%d_%H%M%S")}.csv')
    ...
    try:
        ...
        print(f"\nChecking headers for {len(domains)} domains...")
